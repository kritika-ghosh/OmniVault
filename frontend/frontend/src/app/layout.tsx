        ...
        <WorkspaceProvider>
          <TooltipProvider>
            {isWorkspace ? (
                    ...
                    <header className="w-12 h-full border-r border-border bg-sidebar flex flex-col items-center justify-between py-2 z-50 shrink-0 select-none">
                      <div className="flex flex-col items-center w-full">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent side="right">Toggle File Sidebar</TooltipContent>
                        </Tooltip>

                        {/* Navigation Toolbar */}
                        <div className="flex flex-col items-center gap-2.5 w-full px-2 mt-2">
                          <Tooltip>
                            <TooltipTrigger render={
                              <Link href="/" className="w-8 h-8 rounded-lg flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted/60 transition-all cursor-pointer">
                          ...
                          <div className="w-6 h-[1px] bg-border/50 my-0.5" />
              ...
              // Non-workspace (Landing page) full view
